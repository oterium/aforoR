...
The **Overview** provides essential guidelines on otolith morphology and the interpretation of wavelets. The **Applications** offers tutorials on extracting contour data (coordinates, elliptic fourier descriptors and wavelets at different scales), and the mathematical protocol used for the wavelet analysis. It also provides tutorials for otolith morphometric analysis. The **Publications** list scientific literature cited. The package is only developed in **Applications/Extracting Contour**.
