test_that("process_images works with example image", {
  ...
  # process_images creates a 'Procesamiento' folder
  results_dir <- file.path(temp_dir, "Procesamiento")
  expect_true(dir.exists(results_dir), info = "Procesamiento directory should be created")
  ...
  results_dir2 <- file.path(temp_dir, "Procesamiento2")
  expect_true(dir.exists(results_dir2), info = "Procesamiento2 directory should be created")
