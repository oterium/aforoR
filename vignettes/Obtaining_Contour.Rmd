...
The package determine automatically the initial contour point, which represents the maximum distance from the otolith centroid to this point locating to the right. This point is usually the *rostrum*.
